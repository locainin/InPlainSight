...
int main(void) {
  ...
  {
    plainsight_split_manifest_pack_input input = {PLAINSIGHT_SPLIT_MANIFEST_VERSION,
    ...
    if (!check_true(plainsight_split_manifest_pack(&input, g_manifest_bytes, sizeof(g_manifest_bytes),
  ...
  if (!check_true(plainsight_split_manifest_parse(g_manifest_bytes, packed_len, &parsed_manifest) ==
                      PLAINSIGHT_OK,
  ...
  if (!check_true(plainsight_split_manifest_parse(tampered_manifest, packed_len, &parsed_manifest) ==
