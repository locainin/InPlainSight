...
static plainsight_error plainsight_jpeg_validate_geometry(uint32_t image_width,
...
plainsight_error plainsight_image_jpeg_read(const char *path, plainsight_image *image) {
    ...
    result_code = plainsight_jpeg_validate_geometry(jpeg_state.output_width, jpeg_state.output_height, rgb_bytes);
