...
mod tests {
    ...
    use super::{
        validate_extract_typed_passphrase_inputs, validate_hide_command,
        validate_hide_file_payload_typed_passphrase_inputs, validate_hide_text_inputs,
        validate_hide_text_typed_passphrase_inputs, validate_typed_passphrase_inputs,
    };
